...
## ส่วนที่ 1: ทำให้ระบบทำงาน (เวอร์ชันเข้าใจง่าย)
...
## ส่วนที่ 3: ยกระดับความปลอดภัย (Optional แต่แนะนำมาก)
...
เฉลย: [เฉลย Lab 5](./answers/06_lab_login_answer.md) · เวอร์ชันปลอดภัยเต็ม: [`answers/auth_secure/`](./answers/auth_secure/)
จบ Day 2! ไปต่อ: [Day 3 — Project](../Day3_Project/README.md)
